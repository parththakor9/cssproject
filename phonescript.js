...
function changeProductColor6() {
    const selectedColor = document.getElementById("color").value;
    const mainImage = document.getElementById("main-image");

    // Update image based on selected color
    if (selectedColor === 'black') {
        mainImage.src = 'img/a1b.jpeg';
    } else if (selectedColor === 'white') {
        mainImage.src = 'img/applephone1.jpg';
    } 
}

function changeProductColor7() {
    const selectedColor = document.getElementById("color").value;
    const mainImage = document.getElementById("main-image");

    // Update image based on selected color
    if (selectedColor === 'black') {
        mainImage.src = 'applephone2.jpg';
    } else if (selectedColor === 'white') {
        mainImage.src = 'img/a2w.jpeg';
    } 
}

function changeProductColor8() {
    const selectedColor = document.getElementById("color").value;
    const mainImage = document.getElementById("main-image");

    // Update image based on selected color
    if (selectedColor === 'black') {
        mainImage.src = 'img/applephone3.jpg';
    } else if (selectedColor === 'white') {
        mainImage.src = 'img/a3w.jpeg';
    } 
}
